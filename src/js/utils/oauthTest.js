...
// Rendi disponibili gli oggetti per il debug
window.oauthManager = oauthManager;
window.viteSupabaseMiddleware = viteSupabaseMiddleware;
...
console.log('Oggetti disponibili: oauthManager, viteSupabaseMiddleware');
