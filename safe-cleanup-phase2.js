...
const PHASE2_FILES_TO_DELETE = [
  // Servizi di notifica obsoleti (sostituiti da versioni più semplici)
  'src/core/services/notificationDebugUtils.js',
  ...
  'src/core/services/notificationRenderer.js',
  'src/core/services/notificationStorage.js',
  
  // Servizi non utilizzati
  'src/shared/services/modalService.js', // Confermato non utilizzato
  ...
  'src/css/modules/_variables.scss', // Variabili non più utilizzate
