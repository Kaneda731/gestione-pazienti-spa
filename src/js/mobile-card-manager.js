...
class MobileCardManager {
    ...
    // Inizializza il tracking dell'interazione utente
    static initUserInteractionTracking() {
            ...
            card.addEventListener('touchstart', (e) => {
                ...
                if (!e.target.closest('button, a, input, select, .custom-select-wrapper, .custom-select-trigger')) {
                    try {
                        ...
                        // Ignora silenziosamente errori di vibrazione
                        console.debug('Vibrazione non disponibile:', e.message);
                    }
                }
...
if (window.innerWidth <= 767) {
    document.addEventListener('DOMContentLoaded', () => {
        ...
        MobileCardManager.initUserInteractionTracking();
