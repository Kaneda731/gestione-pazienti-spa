...
const MOCK_DATA = {
  ...
  reparti: [
    {
      id: 1,
      nome: "Medicina",
      descrizione: "Reparto di Medicina Generale",
      attivo: true,
    },
    {
      id: 2,
      nome: "Chirurgia",
      descrizione: "Reparto di Chirurgia Generale",
      attivo: true,
    },
    {
      id: 3,
      nome: "Cardiologia",
      descrizione: "Reparto di Cardiologia",
      attivo: true,
    },
    {
      id: 4,
      nome: "Neurologia",
      descrizione: "Reparto di Neurologia",
      attivo: true,
    },
    {
      id: 5,
      nome: "Ortopedia",
      descrizione: "Reparto di Ortopedia",
      attivo: true,
    },
    {
      id: 6,
      nome: "Pediatria",
      descrizione: "Reparto di Pediatria",
      attivo: true,
    },
    {
      id: 7,
      nome: "Ginecologia",
      descrizione: "Reparto di Ginecologia",
      attivo: false,
    },
  ],
  ...
  diagnosi: [
    ...
    },
    {
      ...
      categoria: "Endocrinologica",
      codice_icd: "E11",
      attivo: true,
    },
    {
      id: 3,
      nome: "Appendicite Acuta",
      categoria: "Chirurgica",
      codice_icd: "K35",
      attivo: true,
    },
    {
    ...
    {
      id: 5,
      nome: "Frattura Femore",
      categoria: "Ortopedica",
      codice_icd: "S72",
      attivo: true,
    },
    {
  ...
  const builder = {
    ...
    _executeQuery() {
      ...
      if (this._selectedFields !== "*") {
        filteredData = this._applyFieldSelection(
          filteredData,
  ...
  const supabaseMock = {
    ...
    from: vi.fn((tableName) => {
      ...
      return {
        // SELECT queries
        select: vi.fn((fields) =>
          createQueryBuilder(tableData, tableName).select(fields)
        ),
...
export function resetSupabaseMockData() {
  ...
  Object.assign(MOCK_DATA, {
    ...
    reparto_diagnosi_compatibilita: [
      ...MOCK_DATA.reparto_diagnosi_compatibilita,
    ],
  });
}
