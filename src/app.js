try {
  ...
  console.error("A critical error occurred in app.js:", e);
  const errorContainer = document.createElement('div');
  errorContainer.style.color = 'red';
  errorContainer.style.padding = '20px';
  errorContainer.innerHTML = `
    <h1>Application Error</h1>
    <p>A critical error occurred that prevented the application from loading. Please see the details below:</p>
    <pre>${e.stack}</pre>
  `;
